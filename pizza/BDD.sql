...
INSERT INTO `ingredient` VALUES (3,'Base Blanche','Blanco',1),(4,'Tomate','Tomato',2),(5,'Carottes',NULL,2),(6,'Base Tomate','Rosso',1),(7,'Anchois',NULL,2),(8,'Olives',NULL,2),(9,'Jambon Serrano',NULL,2),(12,'Poivrons','Peperone',2),(18,'Champignons','Funghi',2),(23,'Comté','Permi',2),(27,'Parmesan','Permigiano',3),(28,'Emmentale','None',3);
...
INSERT INTO `typeingredient` VALUES (1,'Base'),(2,'Crudité'),(3,'fromage');
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `AddTypeIngredient`(
    IN label VARCHAR(100)
)
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `UpdateIngredient`(
...
-- Dump completed on 2024-12-14 11:59:57
